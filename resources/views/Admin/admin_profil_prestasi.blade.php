                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header ui-sortable-handle" style="cursor: move;">
                                    <h3 class="card-title">Tambah Info Prestasi</h3>

                                </div>
                                <div class="card-body ">
                                    <form action="/profil_prestasi/store" enctype="multipart/form-data"
                                        method="POST">
                                        @csrf
                                        <div class="row p-2" >
                                            <div class="col-sm-6 ">
                                                <div class="form-group mt-1">
                                                    <label for="nama">Judul Prestasi</label>
                                        ...
                                        <tbody>
                                            @foreach ($prestasi as $key => $pr)
                                                <tr>
                                                    ...
                                                    <td>{{ $pr->judul_prestasi }}</td>
                                                    <td>{{ $pr->deskripsi }}</td>
                                                    <td>
                                                        <a href="{{ asset('image/prestasi/' . $pr->foto) }}"
                                                            target="_blank">
                                                            {{ $pr->foto }}
                                                        </a>
                                                    </td>
                                                    <td><a href="/profil_prestasi/destroy/{{$pr->id_prestasi}}"><span class="btn btn-danger"><i class="fas fa-trash"> </i></span></a></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
