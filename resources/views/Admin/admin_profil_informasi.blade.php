                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="card card-primary collapsed collapsed-card">
                                <div class="card-header ui-sortable-handle" style="cursor: move;">
                                    <h3 class="card-title">Ganti Informasi</h3>
                                ...
                                <div class="card-body p-2">
                                    <form action="/profil_informasi/update" method="POST">
                                        @csrf
                                        <div class="col-sm-12 ">
                                            <input type="text" value="{{ $infor->id }}" name="id" hidden>
                                            <div class="form-group mt-1">
                                                <textarea name="informasi" class="form-control" rows="3">{{ $infor->informasi }}</textarea>
