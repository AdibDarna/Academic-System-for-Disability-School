                    ...
                    <div class="row">
                                        ...
                                        <tbody>
                                            @foreach ($kelas as $kel)
                                                <tr>
                                                    <td>{{ $kel->kelas }}</td>
                                                    <td>{{ $kel->wali }}</td>
                                                    <td><a href="/sikap_siswa/{{ $kel->id_kelas }}"><span
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($siswa as $key => $si)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/sikap_siswa/{{ $si->id_kelas }}/{{ $si->nis }}/ganjil"
                                                            class="btn btn-primary p-1">Ganjil</a>
                                                        <a href="/sikap_siswa/{{ $si->id_kelas }}/{{ $si->nis }}/genap"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card">
                                ...
                                <form action="/sikap_siswa/inputnilai" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div>
                                            Nama :
                                            ...
                                            <tbody>
                                                ...
                                                <input id="nis" type="text" name="nis"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="kelas"
                                                                value="{{ $id_kelas }}" hidden />
                                                            <input type="text" name="semester"
                                                                value="{{ $sem }}" hidden />
                                                            <input class="form-control"
                                                                placeholder="Masukan Catatan" type="text"
                                                                name="spiritual" required>
                                                        </td>
                                                        <td>
                                                            <input class="form-control"
                                                                placeholder="Masukan Catatan" type="text"
                                                                name="sosial" required>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3">
