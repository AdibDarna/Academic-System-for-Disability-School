                    ...
                    <div class="row mb-4 " style="height:50vh;">
                        ...
                        z-index: 2;">
                            <div class="col-sm-12 d-flex flex-column justify-content-center align-items-center"
                                ...
                                <h1 class="m-0" style=" font-size:40x; text-align:center; color:white; text-shadow:2px 2px 6px #000"><b>Selamat datang calon peserta didik baru
                                    <br>
                                    SMPN 1 CIBADAK
                                    <br>
                                    Tahun Pelajaran 2021-2022</b>
                                </h1>
                                <br>
                                <br>
                                <a class="btn btn-primary" href="" style="color: white">Daftar Sekarang</a>
                            </div>
                        </div>
                                            ...
                                            <div class="card-body p-0">
                                                <div class="d-flex  align-items-start" style="height:100% ">
                                                    <p
                                                        ...
                                                        <span class="text-bold text-lg " >Informasi</span>
                                                       
                                                       
                                                    </p>
                                                </div>
                                                <p class="mt-2 p2 text-bold text-lg" style="text-align: center">{{$f->informasi}}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
