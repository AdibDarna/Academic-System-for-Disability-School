                    ...
                    <div class="row mb-4 " style="height:50vh;">
                        ...
                        z-index: 2;">
                            <div class="col-sm-12 d-flex flex-column justify-content-center align-items-center"
                                ...
                                <h1 class="m-0" style=" font-size:40x; color:white; text-shadow:2px 2px 6px #000"><b>Fasilitas SLB Al Faqih
                                        Pekanbaru</b>
                                </h1>
                                <span style="color: white; text-shadow:2px 2px 6px #000">Terdapat beberapa Fasilitas di SMP Negeri 1 Cibadak
                                    ini</span>
                            </div>
                        </div>
